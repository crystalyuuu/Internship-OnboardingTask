...
namespace MarsQA_1.Pages
{
    public static class SignIn
    {
        ...
        public static void Login()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("(//INPUT[@type='text'])[2]")).SendKeys("crystalyu949@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//INPUT[@type='password']")).SendKeys("123789");
